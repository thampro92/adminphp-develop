                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3" style="padding-left: 0;">
                                    <select class="form-control" id="inputType" name="Loại">
                                        <option value="0">Loại 0: Sử dụng cho chính user đó, dùng duy nhất 1 lần</option>
                                        ...
                                        <option value="3" selected>Loại 3: Một user chỉ được sử dụng 1 Giftcode trong event, gift
