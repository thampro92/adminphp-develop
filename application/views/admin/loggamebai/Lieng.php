...
<?php else: ?>
    ...
    <div class="wrapper">
        ...
        <div class="widget">
            ...
            <form class="list_filter form" action="<?php echo admin_url('loggamebai/lieng') ?>" method="post">
                <div class="formRow">
                    <table>
                        <tr>
                            <td>
                ...
                <div class="formRow">
                    <table>
                        <tr>
                            ...
                            <td>
                                <input type="reset"
                                       onclick="window.location.href = '<?php echo admin_url('loggamebai/lieng') ?>'; "
...
<script>
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo admin_url('loggamebai/liengajax')?>",
            data: {
