...
<!--                    <table>-->
<!--                        <tr>-->
<!--                            <td><label style="margin-left: 90px;margin-bottom:-2px;width: 60px">Tiền:</label></td>-->
<!--                            <td class="">-->
...
<!---->
<!---->
<!--                            <td><label  id = "labelvin" style="margin-left: 60px;margin-bottom:-2px;width: 70px;">Trạng thái</label></td>-->
...
<!--                                </select></td>-->
<!--                            <td><label  id = "labelvin" style="margin-left: 45px;margin-bottom:-2px;width: 100px;">Mệnh giá xu</label></td>-->
...
<!---->
<!--                            <td>-->
<!--                                <label style="margin-left: 50px;margin-bottom:-2px;width: 100px">Loại giftcode:</label></td>-->
<!--                            <td class="item">-->
