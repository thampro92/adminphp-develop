...
<div class="line"></div><link rel="stylesheet"
    ...
    <div class="wrapper">
        ...
        <div class="widget">
            ...
            <form class="list_filter form" action="<?php echo admin_url('report/userwintrans'); echo "/". $name?>" method="post">
                ...
                <div class="formRow">
                    <table>
                        <tr>
                            ...
                            <td>
                                <input type="reset"
                                       onclick="window.location.href = '<?php echo admin_url('report/userwintrans') ?>'; "
