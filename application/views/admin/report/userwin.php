                ...
                <div class="formRow">
                    <table>
                        <tr>
                            ...
                            <td><select class="money-type-2" style="margin-left: 1px; width: 219px!important;" id="game"
                                        name="game">
                                    <option value="" <?php if ($this->input->post('game') == "") {
                                        echo "selected";
                                    } ?>>Tất Cả
                                    </option>
                                    <option value="vb" <?php if ($this->input->post('game') == "vb") {
                                        echo "selected";
                                    } ?>>VB52
                                    </option>
                                    <option value="lux" <?php if ($this->input->post('game') == "lux") {
                                        echo "selected";
                                    } ?>>Lux52
                                    </option>
                                </select></td>
