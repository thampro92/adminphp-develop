            ...
            <div class="formRow">
                ...
                <table>
                    <tr>
                        ...
                        <td><label style="margin-left: 50px;margin-bottom:-2px;width: 100px">Mã Máy:</label></td>
                        <td class="">
                            <input type="text" style="margin-left: 20px;margin-bottom:-2px;width: 150px"
                                   id="devicelogin" value="<?php echo $this->input->post('devicelogin') ?>" name="devicelogin">
                        </td>
            ...
            <div class="formRow">
                <table>
                    <tr>
                        ...
                        <td style="">
                            <button id="search_tran" type="button" class="button blueB"  style="margin-left: 123px">Tìm kiếm</button>
                        </td>
                        <td>
                            <input type="reset"
