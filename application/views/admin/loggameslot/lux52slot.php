                    ...
                    <!-- <table>
                        <tr>
                            ...
                            <td><select class="money-type-2" style="margin-left: 1px; width: 219px!important;" id="game" name="game">
                                    ...
                                    <option value="hero6" <?php if($this->input->post('game') == "hero6"){echo "selected";} ?>>Hero 6</option>
                                    <option value="coco" <?php if($this->input->post('game') == "coco"){echo "selected";} ?>>Coco</option>
                                    <option value="mariospeed" <?php if($this->input->post('game') == "mariospeed"){echo "selected";} ?>>Mario Speed</option>
                ...
                <div class="formRow">
                    <table>
                        <tr>
                            ...
                            <td>
                                <input type="reset"
                                       onclick="window.location.href = '<?php echo admin_url('loggameslot/lux52slot') ?>'; "
...
<script>
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo admin_url('loggameslot/lux52slotajax')?>",
            data: {
