...
<?php else: ?>
    ...
    <div class="wrapper">
        ...
        <div class="widget">
            ...
            <form class="list_filter form" action="<?php echo admin_url('loggameslot/vb52slot') ?>" method="post">
                ...
                <div class="formRow">
                    <table>
                        <tr>
                            ...
                            <td>
                                <input type="reset"
                                       onclick="window.location.href = '<?php echo admin_url('loggameslot/vb52slot') ?>'; "
...
<script>
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo admin_url('loggameslot/vb52slotajax')?>",
            data: {
