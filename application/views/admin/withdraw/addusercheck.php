...
<div class="wrapper">
    <div class="widget">
        <div class="title">
            <h6>Thêm mới đánh dấu tài khoản</h6>
        </div>
        <div id="form" class="form">
            ...
            <fieldset>
                <div class="formRow">
                    ...
                    <div class="formRight">
                        <span class="oneTwo"><input type="text" _autocheck="true" value="<?php echo set_value('nn') ?>" name="nn" id="nn"></span>
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="formRow">
                    ...
                    <div class="formRight">
                        <span class="oneTwo"><input type="text" _autocheck="true" value="<?php echo set_value('stk') ?>" name="stk" id="stk"></span>
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="formRow">
                ...
                <div class="formRow">
                    ...
                    <div class="formRight">
                        <span class="oneTwo"><input type="text" _autocheck="true" value="<?php echo set_value('comment') ?>" name="comment" id="comment"></span>
                    </div>
                    <div class="clear"></div>
                </div>
            </fieldset>
