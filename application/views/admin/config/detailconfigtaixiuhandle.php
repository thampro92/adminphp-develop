...
<div class="wrapper">
    <div class="widget">
        ...
        <?php if ($admin_info->Status == "A"): ?>
            <div class="title">
                <h4>Sửa config fund jackpot tài xỉu<span style="color: #0000FF"></span></h4>
            </div>
            <div class="formRow">
                <div class="row">
                    <div class="col-sm-1 mr-2">
                        <input type="button" id="search_tran" value="Set fun jackpot tài" class="button blueB">
                    </div>
                    <div class="col-sm-1 ml-5">
                        <input type="button" id="search_xiu" value="Set fun jackpot xỉu" class="button blueB">
                    </div>
                </div>
            </div>
