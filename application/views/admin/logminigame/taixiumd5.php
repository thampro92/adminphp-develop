...
<?php else: ?>
    <div class="wrapper">
        ...
        <div class="widget">
            ...
            <div class="title">
                <h6>Lịch sử phiên tài xỉu md5</h6>
            </div>
            <form class="list_filter form" action="<?php echo admin_url('logminigame/taixiumd5') ?>" method="post">
                <div class="formRow">
...
<script>
    ...
    function resultSearchtaixiu(referenceId,totalxiu, totaltai, numxiu, numtai, dice1, dice2, dice3,result,totalrefundtai,totalrefundxiu,money,datetime,total_jackpot) {
        var rs = "";
        rs += "<tr>";
        rs += "<td><a style='color: #0000FF' href='detailphientaixiumd5/"+referenceId+ "/history"+ query() +"'>"+referenceId+"</a></td>";
    ...
    function init() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo admin_url('logminigame/taixiumd5ajax')?>",
            data: {
                phientx: $("#phientx").val(),
