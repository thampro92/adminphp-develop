...
<div class="wrapper">
    <div class="widget">
        ...
        <div class="formRow">
            <form class="list_filter form" action="<?php echo admin_url('logminigame/detailphientaixiumd5/'.$phien . '/' . $uriParam) ?>" method="post">
                <table>
                    <tr>
...
function init() {
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo admin_url('logminigame/detailphientaixiuajaxmd5')?>",
        data: {
            phientx: $("#phientx").val(),
            cuadat: $("#bet_side").val(),
