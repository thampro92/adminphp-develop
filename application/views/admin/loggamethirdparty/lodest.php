...
<script>
    ...
    function resultList(stt, value) {
        ...
        if(value.GameMode == 1){
            ...
            rs += "<td>Đuôi</td>";
        }else if(value.GameMode == 15){
            rs += "<td>Lô Trượt Xiên 4</td>";
        }else if(value.GameMode == 16){
            rs += "<td>Lô Trượt Xiên 8</td>";
        }
    ...
    function initData() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo admin_url('loggamethirdparty/lodestAjax')?>",
            data: {
                nn: $("#nn").val(),
                ft: $("#fromDate").val(),
                et : $("#toDate").val(),
